...
import com.be4tech.b4collectneo.service.DataVitalService;
...
public class DataVitalResource {
    ...
    private final DataVitalService dataVitalService;

    private final DataVitalRepository dataVitalRepository;

    public DataVitalResource(DataVitalService dataVitalService, DataVitalRepository dataVitalRepository) {
        this.dataVitalService = dataVitalService;
    ...
    public ResponseEntity<DataVital> createDataVital(@RequestBody DataVital dataVital) throws URISyntaxException {
        ...
        DataVital result = dataVitalService.save(dataVital);
    ...
    public ResponseEntity<DataVital> updateDataVital(
        ...
        DataVital result = dataVitalService.update(dataVital);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<DataVital> partialUpdateDataVital(
        ...
        Optional<DataVital> result = dataVitalService.partialUpdate(dataVital);
    ...
    public List<DataVital> getAllDataVitals() {
        ...
        return dataVitalService.findAll();
    }
    ...
    public ResponseEntity<DataVital> getDataVital(@PathVariable String id) {
        ...
        Optional<DataVital> dataVital = dataVitalService.findOne(id);
