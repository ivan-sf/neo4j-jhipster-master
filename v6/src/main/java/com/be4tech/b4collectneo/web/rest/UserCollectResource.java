...
import com.be4tech.b4collectneo.service.UserCollectService;
...
public class UserCollectResource {
    ...
    public UserCollectResource(UserCollectService userCollectService, UserCollectRepository userCollectRepository) {
    ...
    public ResponseEntity<UserCollect> updateUserCollect(
        ...
        UserCollect result = userCollectService.update(userCollect);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<UserCollect> partialUpdateUserCollect(
        ...
        Optional<UserCollect> result = userCollectService.partialUpdate(userCollect);
    ...
    public ResponseEntity<UserCollect> getUserCollect(@PathVariable String id) {
        ...
        Optional<UserCollect> userCollect = userCollectService.findOne(id);
