...
class DataVitalResourceIT {
    ...
    void putExistingDataVital() throws Exception {
        ...
        updatedDataVital.vitalKey(UPDATED_VITAL_KEY).eventType(UPDATED_EVENT_TYPE).date(UPDATED_DATE).data(UPDATED_DATA);
    ...
    void partialUpdateDataVitalWithPatch() throws Exception {
        ...
        partialUpdatedDataVital.date(UPDATED_DATE).data(UPDATED_DATA);
    ...
    void fullUpdateDataVitalWithPatch() throws Exception {
        ...
        partialUpdatedDataVital.vitalKey(UPDATED_VITAL_KEY).eventType(UPDATED_EVENT_TYPE).date(UPDATED_DATE).data(UPDATED_DATA);
