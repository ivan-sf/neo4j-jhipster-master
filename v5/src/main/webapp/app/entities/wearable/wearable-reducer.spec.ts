...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wearable.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEARABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEARABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEARABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEARABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEARABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEARABLE actions', async () => {
      const expectedActions = [
        {
