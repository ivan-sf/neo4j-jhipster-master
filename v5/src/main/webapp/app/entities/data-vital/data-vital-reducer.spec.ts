...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATAVITAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_DATAVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DATAVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DATAVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DATAVITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DATAVITAL actions', async () => {
      const expectedActions = [
        {
