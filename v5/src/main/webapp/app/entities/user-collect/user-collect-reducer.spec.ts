...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCOLLECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERCOLLECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERCOLLECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERCOLLECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERCOLLECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERCOLLECT actions', async () => {
      const expectedActions = [
        {
