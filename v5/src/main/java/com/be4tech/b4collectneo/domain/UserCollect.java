...
public class UserCollect implements Serializable {
    ...
    public void setDataVitals(Set<DataVital> dataVitals) {
        if (this.dataVitals != null) {
            this.dataVitals.forEach(i -> i.setUserCollect(null));
        }
        if (dataVitals != null) {
            dataVitals.forEach(i -> i.setUserCollect(this));
        }
        this.dataVitals = dataVitals;
    }

    public UserCollect dataVitals(Set<DataVital> dataVitals) {
        this.setDataVitals(dataVitals);
        return this;
    }

    public UserCollect addDataVital(DataVital dataVital) {
        this.dataVitals.add(dataVital);
        return this;
    }

    public UserCollect removeDataVital(DataVital dataVital) {
