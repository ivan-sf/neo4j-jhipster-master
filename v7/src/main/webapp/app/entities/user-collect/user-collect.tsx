  ...
  return (
    <div>
      <h2 id="user-collect-heading" data-cy="UserCollectHeading">
        <Translate contentKey="v7App.userCollect.home.title">User Collects</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="v7App.userCollect.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/user-collect/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="v7App.userCollect.home.createLabel">Create new User Collect</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userCollectList && userCollectList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="v7App.userCollect.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.userCollect.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.userCollect.lastName">Last Name</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.userCollect.username">Username</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.userCollect.vitalKey">Vital Key</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="v7App.userCollect.home.notFound">No User Collects found</Translate>
            </div>
          )
        )}
      </div>
