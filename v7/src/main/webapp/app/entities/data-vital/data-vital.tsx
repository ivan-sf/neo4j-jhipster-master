  ...
  return (
    <div>
      <h2 id="data-vital-heading" data-cy="DataVitalHeading">
        <Translate contentKey="v7App.dataVital.home.title">Data Vitals</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="v7App.dataVital.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/data-vital/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="v7App.dataVital.home.createLabel">Create new Data Vital</Translate>
          </Link>
        </div>
      </h2>
        ...
        {dataVitalList && dataVitalList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="v7App.dataVital.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.dataVital.date">Date</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.dataVital.data">Data</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.dataVital.eventType">Event Type</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.dataVital.vitalKey">Vital Key</Translate>
                </th>
                <th>
                  <Translate contentKey="v7App.dataVital.vitalKey">Vital Key</Translate>
                </th>
            ...
            <tbody>
              {dataVitalList.map((dataVital, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{dataVital.vitalKey ? <Link to={`/user-collect/${dataVital.vitalKey.id}`}>{dataVital.vitalKey.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="v7App.dataVital.home.notFound">No Data Vitals found</Translate>
            </div>
          )
        )}
      </div>
